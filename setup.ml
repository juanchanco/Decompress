...
(* OASIS_START *)
(* DO NOT EDIT (digest: ff7b17931b79add368d416cca160d827) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Generate shared C library of Decompress";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-inline"; "1000"])]
                   },
                   {
                      lib_modules =
                        [
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\167rd\153q9\185\210\172-\245*\178\b\140A";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
